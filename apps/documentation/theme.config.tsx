...
const themeConfig: DocsThemeConfig = {
  logo: <span>VanRein</span>,
  head: function useHead() {
    const config = useConfig<{ title?: string; description?: string }>();

    const title = `${config.frontMatter.title} | VanRein Docs` || 'VanRein Docs';
    const description = config.frontMatter.description || 'The official VanRein documentation';
